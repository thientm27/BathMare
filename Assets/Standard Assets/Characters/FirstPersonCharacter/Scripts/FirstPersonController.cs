...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            Physics.SphereCast(base.transform.position, m_CharacterController.radius, Vector3.down,
                out RaycastHit hitInfo, m_CharacterController.height / 2f, -1, QueryTriggerInteraction.Ignore);
        ...
        private void ProgressStepCycle(float speed)
        {
            ...
            {
                m_StepCycle +=
                    (m_CharacterController.velocity.magnitude + speed * ((!m_IsWalking) ? m_RunstepLenghten : 1f)) *
                    Time.fixedDeltaTime;
            }
        ...
        private void UpdateCameraPosition(float speed)
        {
            if (m_UseHeadBob)
            {
                ...
                else
                {
                    ...
                    m_Camera.transform.DOLocalMove(localPosition, 0.5f);
        ...
        public void Crouch()
        {
            if (!crouched)
            {
                ...
                iTween.ValueTo(base.gameObject,
                    iTween.Hash("from", controller.height, "to", CrouchToSize, "time", CrouchSpeed, "onupdate",
                        "ValueChange"));
            ...
            else
            {
                ...
                iTween.Stop(base.gameObject);
                iTween.ValueTo(base.gameObject,
                    iTween.Hash("from", controller.height, "to", CrouchFromSize, "time", CrouchSpeed, "onupdate",
                        "ValueChange"));
